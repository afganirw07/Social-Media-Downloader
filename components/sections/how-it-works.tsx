  ...
  const steps = [
    {
      ...
      icon: <Link2 className="w-full h-full text-emerald-600" strokeWidth={1.5} />
    },
    {
      number: "2",
      title: "Click Download",
      description: "Our system instantly processes your video and prepares it for download in the best quality",
      icon: <Download className="w-full h-full text-emerald-600
" strokeWidth={1.5} />
    },
    {
      number: "3",
      ...
      icon: <Sparkles className="w-full h-full text-emerald-600" strokeWidth={1.5} />
    }
  ]
