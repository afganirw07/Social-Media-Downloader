        ...
        <>
            <div className="bg-grid-fade flex flex-col justify-center items-center py-16 px-4 lg:px-8">
                ...
                <div className="mt-10 flex flex-wrap justify-center gap-3">
                    {/* No watermark Badge */}
                    <div className="group relative flex items-center gap-2 rounded-full border border-blue-500/30 bg-linear-to-r from-blue-500/10 to-transparent px-5 py-2.5 text-sm font-medium text-black shadow-lg transition-all duration-300 ">
                    ...
                    {/* HD Quality Badge */}
                    <div className="group relative flex items-center gap-2 rounded-full border border-green-500/30 bg-linear-to-r from-green-500/10 to-transparent px-5 py-2.5 text-sm font-medium text-black shadow-lg transition-all duration-300">
                    ...
                    {/* 100% Free Badge */}
                    <div className="group relative flex items-center gap-2 rounded-full border border-purple-500/30 bg-linear-to-r from-purple-500/10 to-transparent px-5 py-2.5 text-sm font-medium text-black shadow-lg transition-all duration-300">
                    ...
                    {/* Fast Download Badge */}
                    <div className="group relative flex items-center gap-2 rounded-full border border-orange-500/30 bg--to-r from-orange-500/10 to-transparent px-5 py-2.5 text-sm font-medium text-black shadow-lg transition-all duration-300">
